...
GAME_URL = "https://zooma-wheel.pages.dev"
...
def send_welcome(message):
    ...
    caption = "🐙 Добро пожаловать в Zooma Lucky Wheel!\n\nКрути колесо и выигрывай призы — фриспины, бонусы и многое другое 👇"
    markup = get_markup()
...
def send_stats(message):
    ...
    try:
        ...
        d = r.json()
        text = (
            f"📊 Zooma Lucky Wheel — Статистика\n\n"
            f"Всего:\n"
